...
def show_menu():
    ...
    st.sidebar.page_link("pages/2_DemandeEau.py", label="💧 Water demand")
    st.sidebar.page_link("pages/3_ZoneEtudiee.py", label="📍 Study area")
    st.sidebar.page_link("pages/4_Periode.py", label="📅 Period choice")
    st.sidebar.page_link("pages/5_Economie.py", label="💰 Economy")
    st.sidebar.page_link("pages/6_EmissionsCO2.py", label="🌿 CO₂ emissions")
